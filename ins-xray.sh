...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/H-Pri3l/1/main/nginx.conf" 
#mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/H-Pri3l/1/main/vps.conf"
